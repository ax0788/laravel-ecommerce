        ...
        <div class="row">
         <div class="col-12">
          ...
          <div class="row">
           <div class="col-md-4">
            <div class="form-group">
             ...
             <div class="controls">
              <select name="subsubcategory_id" id="subsub" class="form-control" required>
            ...
            <div class="form-group">
             ...
             <div class="controls">
              <input type="text" name="product_name_cn" class="form-control" required
               value="{{ $products->product_name_cn }}">
            ...
            <div class="form-group">
             ...
             <div class="controls">
              <input type="text" name="product_tags_en" class="form-control" data-role="tagsinput"
               placeholder="add tags" required value="{{ $products->product_tags_en }}">
          ...
          <div class="row">
           <div class="col-md-4">
            <div class="form-group">
             ...
             <div class="controls">
              <input type="text" name="product_tags_cn" class="form-control" data-role="tagsinput"
               placeholder="add tags" required value="{{ $products->product_tags_cn }}">
          ...
          <div class="row">
            ...
            <div class="form-group">
             ...
             <div class="controls">
              <input type="text" name="product_color_en" class="form-control" data-role="tagsinput"
               placeholder="add tags" value="{{ $products->product_color_en }}">
           ...
           <div class="col-md-6">
            <div class="form-group">
             <h5>Product Color Cn <span class="text-danger">*</span></h5>
             <div class="controls">
              <input type="text" name="product_color_cn" class="form-control" data-role="tagsinput"
               placeholder="add tags" value="{{ $products->product_color_cn }}">
          ...
          <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
             ...
             <div class="controls">
              <textarea name="short_descp_cn" id="textarea" class="form-control" required>
    ...
    if (subcategory_id) {
     $.ajax({
      ...
      success: function(data) {
       ...
       $.each(data, function(key, value) {
        $('select[name="subsubcategory_id"]').append('<option value="' + value.id + '">' + value
